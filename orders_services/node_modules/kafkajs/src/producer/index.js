...
const { CONNECTION_STATUS } = require('kafkajs/src/network/connectionStatus')
const { DefaultPartitioner } = require('kafkajs/src/producer/partitioners')
const InstrumentationEventEmitter = require('kafkajs/src/instrumentation/emitter')
const createEosManager = require('kafkajs/src/producer/eosManager')
const createMessageProducer = require('kafkajs/src/producer/messageProducer')
const { events, wrap: wrapEvent, unwrap: unwrapEvent } = require('kafkajs/src/producer/instrumentationEvents')
 ...
 * @param {import('kafkajs').ICustomPartitioner} [params.createPartitioner]
...
module.exports = ({
  ...
  /** @type {import("kafkajs").Producer["on"]} */
