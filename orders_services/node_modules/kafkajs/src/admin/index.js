const createRetry = require('kafkajs/src/retry')
const waitFor = require('kafkajs/src/utils/waitFor')
const groupBy = require('kafkajs/src/utils/groupBy')
const createConsumer = require('kafkajs/src/consumer')
const InstrumentationEventEmitter = require('kafkajs/src/instrumentation/emitter')
const { events, wrap: wrapEvent, unwrap: unwrapEvent } = require('kafkajs/src/admin/instrumentationEvents')
const { LEVELS } = require('kafkajs/src/loggers')
const {
...
} = require('kafkajs/src/errors')
const { staleMetadata } = require('kafkajs/src/protocol/error')
const CONFIG_RESOURCE_TYPES = require('kafkajs/src/protocol/configResourceTypes')
const ACL_RESOURCE_TYPES = require('kafkajs/src/protocol/aclResourceTypes')
const ACL_OPERATION_TYPES = require('kafkajs/src/protocol/aclOperationTypes')
const ACL_PERMISSION_TYPES = require('kafkajs/src/protocol/aclPermissionTypes')
const RESOURCE_PATTERN_TYPES = require('kafkajs/src/protocol/resourcePatternTypes')
const { EARLIEST_OFFSET, LATEST_OFFSET } = require('kafkajs/src/constants')
 ...
 *
 * @param {Object} params
 * @param {import("kafkajs").Logger} params.logger
 * @param {InstrumentationEventEmitter} [params.instrumentationEmitter]
 * @param {import('kafkajs').RetryOptions} params.retry
 * @param {import("kafkajs").Cluster} params.cluster
 *
...
module.exports = ({
   ...
   * @param {Object} request
   * @param {import("kafkajs").IPartitionReassignment[]} request.topics topics and the paritions to be reassigned
   ...
   * @param {Object} request
   * @param {import("kafkajs").TopicPartitions[]} request.topics topics and the paritions to be returned, if this is null will return all the topics.
   * @param {number} [request.timeout]
   * @returns {Promise<import("kafkajs").ListPartitionReassignmentsResponse>}
   */
