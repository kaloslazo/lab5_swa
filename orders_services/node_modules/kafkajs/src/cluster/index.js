const BrokerPool = require('kafkajs/src/cluster/brokerPool')
const Lock = require('kafkajs/src/utils/lock')
const sharedPromiseTo = require('kafkajs/src/utils/sharedPromiseTo')
const createRetry = require('kafkajs/src/retry')
const connectionPoolBuilder = require('kafkajs/src/cluster/connectionPoolBuilder')
...
module.exports = class Cluster {
   ...
   * @param {import("kafkajs").RetryOptions} options.retry
   * @param {import("kafkajs").Logger} options.logger
   * @param {import("kafkajs").ISocketFactory} options.socketFactory
   * @param {Map} [options.offsets]
   * @param {import("kafkajs/src/instrumentation/emitter")} [options.instrumentationEmitter=null]
   */
  constructor({
    logger: rootLogger,
    socketFactory,
  ...
  /**
   * @public
   * @returns {Promise<import("kafkajs").BrokerMetadata>}
   */
   ...
   * @returns {Promise<import("kafkajs").Broker>}
   */
   ...
   * @public
   * @param {string} topic
   * @returns {import("kafkajs").PartitionMetadata[]} Example:
   *                   [{
   *                     isr: [2],
   *                     leader: 2,
   ...
   * @param {import("kafkajs/src/protocol/coordinatorTypes").CoordinatorType} [params.coordinatorType=0]
   * @returns {Promise<import("kafkajs").Broker>}
   */
   ...
   *                            }
   *                          ]
   * @returns {Promise<import("kafkajs").TopicOffsets[]>} example:
   *                          [
   *                            {
   *                              topic: 'my-topic-name',
   *                              partitions: [
